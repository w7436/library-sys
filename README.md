...
主要业务：管理学校图书信息，并对班级、学生、图书、用户以及图书借阅信息进行记录管理
...
<img src="README.assets/用户登录.png" alt="用户登录" style="zoom: 67%;" />

### 班级管理

- 查询班级列表

  ![班级查询](README.assets/班级查询.png)

- 新增班级

  <img src="README.assets/image-20210210163743820.png" alt="image-20210210163743820" style="zoom: 33%;" />

- 修改班级

  ![image-20210211143652871](README.assets/image-20210211143652871.png)

- 删除班级

  ![image-20210211143718545](README.assets/image-20210211143718545.png)
...
要实现功能，需要先明确前后端约定好的接口，主要实现图书借阅信息管理，实现该业务相关接口。
